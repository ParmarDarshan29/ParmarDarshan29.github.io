  ...
  return (
    <nav style={{ backgroundColor: '#555', color: '#fff', padding: '1rem', position: 'sticky', top: '0', zIndex: '10', transition: 'background-color 0.3s ease' }}>
      <ul style={{ listStyle: 'none', display: 'flex', gap: '1rem', margin: '0' }}>
        ...
        <li><Link to="/education" style={{ color: '#fff', textDecoration: 'none', padding: '0.5rem', borderRadius: '5px', transition: 'background-color 0.3s ease, color 0.3s ease' }} onMouseOver={(e) => { e.target.style.backgroundColor = '#ff6600'; e.target.style.color = '#fff'; }} onMouseOut={(e) => { e.target.style.backgroundColor = 'transparent'; e.target.style.color = '#fff'; }}>Education</Link></li>
