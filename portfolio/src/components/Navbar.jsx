...
const Navbar = () => {
  ...
  <li><Link to="/activities" style={{ color: '#fff', textDecoration: 'none', padding: '0.5rem', borderRadius: '5px', transition: 'background-color 0.3s ease, color 0.3s ease' }} onMouseOver={(e) => { e.target.style.backgroundColor = '#ff6600'; e.target.style.color = '#fff'; }} onMouseOut={(e) => { e.target.style.backgroundColor = 'transparent'; e.target.style.color = '#fff'; }}>Activities</Link></li>
